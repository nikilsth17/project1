...
//       await JournaUnApproveService.updateIncomeUnApprove(
//         updatedData.id,
//         updatedData
//       );
...
// export default IncomeUnApprove;
...
const IncomeUnApprove = () => {
  ...
  const handleSubmit = async (values) => {
    try {
      ...
      switch (actionType) {
        case "approve":
          updateFunction = JournalApproveService.updateIncomeApprove; // Replace with your actual approve API function
          destinationRoute = "/approved";
          break;
        case "reject":
          updateFunction = JournalApproveService.updateIncomeReject; // Replace with your actual approve API function
          destinationRoute = "/unapproved";
          break;
        case "unapprove":
          updateFunction = JournaUnApproveService.updateIncomeUnApprove; // or unapproveApiFunction, based on your requirement
          destinationRoute = "/unapproved";
          break;
        default:
          return;
