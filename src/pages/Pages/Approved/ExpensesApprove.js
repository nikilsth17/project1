...
const ExpensesApprove = (props) => {
  ...
  const handleSave = async () => {
    try {
      ...
      await JournalApproveService.updateExpensesApprove(
        updatedData.id,
        updatedData
      );
  ...
  const handleReject = async () => {
    try {
      ...
      await JournalApproveService.updateExpensesReject(
        updatedData.id,
        updatedData
      );
      console.log("Done", updatedData);
...
export default ExpensesApprove;
