  ...
  const fetchItemDetail = async () => {
    try {
      ...
      formik.setValues({
        name: items.name,
        categoryId: {
          label: items.category?.title,
          value: items.category?.id,
        },
        price: items.price,
                ...
                <CardBody>
                  ...
                  <div>
                    ...
                    <Select
                      ...
                      onChange={(selectedOption) => {
                        formik.setFieldValue("unit", selectedOption); // Update unit field value to selected option's value
                      }}
                      onBlur={() => {
            ...
            <CardBody>
              <Row>
                ...
                <Col lg={4}>
                  ...
                  <Label htmlFor="tags" className="form-label mt-2">
                    Tags:
                  </Label>
                  <Input
                    type="text"
                ...
                <Col lg={4}>
                  <Label htmlFor="shelfLife" className="form-label mt-2">
                    Shelf Life:
                  </Label>
                  <Input
                    type="text"
                  ...
                  <Label htmlFor="energy" className="form-label mt-2">
                    Energy:
                  </Label>
                  <Input
                    type="text"
                  ...
                  <Label htmlFor="ingredients" className="form-label mt-2">
                    Ingredients:
                  </Label>
                  <Input
                    type="text"
