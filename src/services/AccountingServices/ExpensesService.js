...
const ExpensesService = {
  create: async (postData) => {
    ...
    try {
      ...
      const response = await instance.post("/ExpenseVoucher/Create", postData);
  ...
  getList: async () => {
    // eslint-disable-next-line no-useless-catch
    try {
      const response = await instance.get("/ExpenseVoucher/GetList");
  ...
  delete: async (voucherNo) => {
    ...
    try {
      ...
      const response = await instance.delete(
        `/ExpenseVoucher/Delete/?id=` + voucherNo
      );
  ...
  view: async (id) => {
    ...
    try {
      ...
      const response = await instance.get(`/ExpenseVoucher/GetDetail?id=` + id);
  ...
  update: async (voucherNo, updatedData) => {
    ...
    try {
      const response = await instance.patch(
        `/ExpenseVoucher/Update?id=` + voucherNo,
        updatedData
      );
